...
land_hexes =  list(map(lambda x: [0, x], range(58))) + list(map(lambda x: [0, x], range(94, 100))) + \
              ...
              list(map(lambda x: [20, x], range(47))) + list(map(lambda x: [20, x], range(48,53))) + list(map(lambda x: [20, x], range(91, 100))) + \
              list(map(lambda x: [21, x], range(47))) + list(map(lambda x: [21, x], range(48,56))) + list(map(lambda x: [21, x], range(92, 100))) + \
              list(map(lambda x: [22, x], range(7,46))) + list(map(lambda x: [22, x], range(48,57))) + list(map(lambda x: [22, x], range(92, 100))) + \
              list(map(lambda x: [23, x], range(8,45))) + list(map(lambda x: [23, x], range(48,58))) + list(map(lambda x: [23, x], range(93, 100))) + \
              list(map(lambda x: [24, x], range(13,43))) + list(map(lambda x: [24, x], range(48,57))) + list(map(lambda x: [24, x], range(93, 100))) + \
              list(map(lambda x: [25, x], range(21,40))) +  [[25, 14]] +  [[25, 1]] + [[25, 18]] +  [[25, 19]] + list(map(lambda x: [25, x], range(50,57))) + list(map(lambda x: [25, x], range(92, 100)))             
